...
<body>
	...
	<form name="addInventory" action="InventoryServlet" method = "get"><%-- ??change?? --%>
	<center> <h3>Add Product</h3>
			...
			<tr>			
						...
						<td><input type="text" name="ManufacturingDate" /></td>
			</tr>				
			<tr></tr>
			<tr>	
						<td colspan="2" align="center"><input type="submit" class="submit_btn" value="ADD PRODUCT"></td>
