...
<body>
	...
	<form name="updateEmployee" action="EmployeeUpdate" method = "get"><%-- ??change?? --%>
	<center><h2> Update Employee Details</h2>
	 <%  Connection  conn7=null;  
            conn7 = DatabaseConnection.getConnection();%>
			<table>
			<tr>
			...
			<tr>	
						<td colspan="2"><input type="submit" class="submit_btn" value="UPDATE"></td>
    ...
    <font size="4" color="white">To Return to your actions page &nbsp; Click here ->&nbsp;</font>
        <input type="submit" class="submit_btn" value=" MY PAGE">
        </center>
        </form>
